...
const HomeAbout = () => {
    return (
        <div className='w-full bg-[#F5F5F5]'>
            <section className='px-4 relative max-w-[1200px] mx-auto py-[100px]'>
