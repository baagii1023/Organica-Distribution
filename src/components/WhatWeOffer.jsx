...
const WhatWeOffer = () => {
    ...
    const { offer, whatWeOfferTitle } = translation[language] || translation['mn'];
    ...
    const iconMapping = {
        ...
        "Бөөний ундаа": <RiDrinks2Fill className='text-[#578440] text-3xl' />,
        "Бөөний амттан": <LuCandy className='text-[#578440] text-3xl' />,
        "Бөөний зууш": <RiCake3Fill className='text-[#578440] text-3xl' />
    };

    const getIcon = (title) => {
        const icon = iconMapping[title];
        return icon || <RiDrinks2Fill className='text-[#578440] text-3xl' />;
    };
        ...
        <section className='px-4 relative max-w-[1200px] mx-auto flex flex-col py-[100px]'>
            ...
            <div className='w-full flex flex-col lg:flex-row pt-[80px] items-center gap-[64px]'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <p className='leading-[150%] text-[#888]'>{offer[0].details[0]}</p>
                </div>
            </div>
