        ...
        <div className='w-full flex lg:flex-row flex-col py-[80px]'>
          <div className='basis-[40%]'>
            <ReactImageMagnify
              ...
              className='w-[275px] h-auto md:basis-[40%] object-contain style={{ width: 275, height: 500 }}'
            />
          </div>
          ...
          <div className='basis-[60%] flex flex-col justify-center'>
            ...
            <a className='bg-[#FF6D00] px-6 py-3 text-white w-fit mt-6' href='/contact'>
              {productText.PriceButton}
            </a>
          </div>
        </div>
