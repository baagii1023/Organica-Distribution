...
const HouseholdDetails = () => {
  ...
  const product = productText.Household.find((item) => item.id === parseInt(id)); 
      ...
      <section className='relative max-w-[1200px] mx-auto px-4 md:px-10 flex flex-col items-center justify-center'>
        <div className='w-full flex lg:flex-row flex-col py-[80px]'>
          <div className='basis-[40%] '>
            <img className='w-[275px] h-auto md:basis-[40%] object-contain' src={product.image} alt={product.HouseholdName} />
          </div>

          <div className='basis-[60%] flex flex-col justify-center'>
            <h3 className='font-semibold text-3xl'>{product.HouseholdName}</h3>
        ...
        <div className='w-full mt-24'>
          ...
          <div className='w-full flex flex-wrap gap-4 py-[64px]'>
            {productText.Household.map((product, index) => (
